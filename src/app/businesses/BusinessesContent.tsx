...
import { getAllBusinesses, industries } from "@/lib/data";
      ...
      >
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <Typography variant="body1" sx={{ color: bharat.brown.light, fontSize: "1.1rem" }}>
            Every venture under Vivekananda Technology Labs carries forward our mission: technology
            that serves humanity, built on the timeless principles of Bharat.
          </Typography>
        </Container>
      </Box>
        ...
        <Container maxWidth="xl">
          {businesses.length === 0 ? (
            <Box sx={{ textAlign: "center", py: 8 }}>
              <Typography variant="h4" sx={{ fontFamily: "var(--font-playfair)", mb: 2, color: bharat.brown.light }}>
                Building the Future, One Venture at a Time
              </Typography>
              <Typography variant="body1" sx={{ color: bharat.brown.light, mb: 4 }}>
                Our first ventures are currently in development. We are laying the foundation for
                companies that will define the next era of Indian technology.
              </Typography>
